...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2018 at 07:09 AM
...
(7, 1, 'Tes Rekomtek', 2018, 'Rekomtek', NULL, '', '', '', '', '', '', 1),
(8, 1, 'TTTTTT', 2018, 'Teknologi dan Terapan Terpadu', 0, '', '', '', '', '', '', NULL),
(9, 1, 'Pilot Test', 2018, 'Pilot Project', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 1, 'Latek', 2019, 'Layanan Teknis', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 30, 'Pengembangan Sistem Informasi BLU', 2019, 'Teknologi dan Terapan Terpadu', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 1, 'Suasana Closing Meeting Audit Kinerja', 2019, 'Layanan Internal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, 1, 'Revitalisasi Website B4T', 2019, 'Teknologi dan Terapan Terpadu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 1, 'tes ahmad', 2018, 'Teknologi dan Terapan Terpadu', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `rmp_activity` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_activity`
--

INSERT INTO `rmp_activity` (`id`, `rmp_id`, `kegiatan`, `deskripsi`, `parent`, `hasil`, `sarpras`, `anggaran`, `pj`, `waktu`, `bobot`) VALUES
(2, 3, 'Penyusunan panduan teknis inspeksi sungai dan prasarana sungai', '', 'B', '', '', NULL, '', '', 0),
(3, 3, 'Penyusunan tim pelaksana dan narasumber', '', 'A', 'SK Narasumber dan Ketua', 'Printer, komputer, ATK', 500000, 'Rahmat Suria Lubis, S.T., M.T.', '1-4', 0),
(6, 3, 'Pengembangan perangkat lunak inspeksi sungai dan prasarana sungai', '', 'B', '', '', NULL, '', '', 0),
(7, 3, 'Laporan Berkala (Bulanan) Simonev', '', 'C', 'Laporan Berkala Simonev', 'Internet, komputer, printer', 19400000, 'Faisal Syaiful Anwar, S.Kom', '40-42', 0),
(8, 3, 'Konsep laporan akhir dan konsep output kegiatan', '', 'C', 'Laporan Konsep Akhir Kegiatan', 'Internet, komputer, printer', 20000000, 'Rahmat Suria Lubis, S.T., M.T.', '41-43', 0),
(9, 3, 'Laporan akhir dan output kegiatan', '', 'C', 'Laporan Akhir ', 'Printer, Komputer, ATK, Scanner', 20000000, 'Rahmat Suria Lubis, S.T., M.T.', '46-48', 0),
(10, 3, 'Diskusi Rancangan Kerja', '', 'A', 'Hasil Diskusi Raker', 'Laptop, Printer', 2500000, 'Rahmat Suria Lubis, S.T., M.T.', '5-8', 0),
(11, 3, 'Penyusunan Rencana Mutu Pelaksanaan (RMP)', '', 'A', 'Dokumen RMP', 'Printer, Komputer, ATK, Scanner, Internet', 12000000, 'Rahmat Suria Lubis, S.T., M.T.', '5-13', 0);

-- --------------------------------------------------------

--
-- Table structure for table `rmp_activity_executor`
--

CREATE TABLE IF NOT EXISTS `rmp_activity_executor` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_activity_executor`
--
...
CREATE TABLE IF NOT EXISTS `rmp_bibliography` (
`id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_bibliography`
--
...
CREATE TABLE IF NOT EXISTS `rmp_document` (
`id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_document`
--
...
--
-- Table structure for table `rmp_rab_activity`
--

CREATE TABLE IF NOT EXISTS `rmp_rab_activity` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rmp_record_list` (
`id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_record_list`
--
...
--
-- Dumping data for table `rmp_roles`
--
...
CREATE TABLE IF NOT EXISTS `rmp_sdk` (
`id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
  `no` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_sdk`
--
...
--
-- Table structure for table `rmp_sdk_list`
--

CREATE TABLE IF NOT EXISTS `rmp_sdk_list` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `rmp_sdk_plan_act`
--

CREATE TABLE IF NOT EXISTS `rmp_sdk_plan_act` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_sdk_plan_act`
--

INSERT INTO `rmp_sdk_plan_act` (`id`, `act_id`, `month`, `week`, `sdk_id`, `biaya`, `fisik`) VALUES
(1, 3, 1, 0, 2, 500000, 0),
(2, 11, 2, 0, 2, 1000000, 0),
(3, 11, 2, 0, 0, 2000000, 1),
(4, 11, 2, 0, 8, 1000000, 0.01),
(5, 10, 2, 0, 6, 1000000, 0.47),
(6, 3, 1, 0, 3, 500000, 0.09);

-- --------------------------------------------------------

--
-- Table structure for table `rmp_sdk_plan_stage`
--

CREATE TABLE IF NOT EXISTS `rmp_sdk_plan_stage` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `rmp_sdk_title`
--

CREATE TABLE IF NOT EXISTS `rmp_sdk_title` (
`id` int(11) NOT NULL,
  `rmp_sdk_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `details` varchar(255) NOT NULL,
...
--
-- Dumping data for table `rmp_sdk_title`
--
...
CREATE TABLE IF NOT EXISTS `rmp_sdm` (
`id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_sdm`
--
...
CREATE TABLE IF NOT EXISTS `rmp_stages` (
`id` int(11) NOT NULL,
  `act_id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_stages`
--

INSERT INTO `rmp_stages` (`id`, `act_id`, `kegiatan`, `deskripsi`, `hasil`, `sarpras`, `anggaran`, `pj`, `waktu`, `bobot`) VALUES
(1, 2, 'Penentuan parameter inspeksi sarana dan prasarana sungai', '', 'Parameter inspeksi', 'Printer, komputer, ATK', 100000000, 'Faisal Syaiful Anwar, S.Kom', '17-26', NULL),
(2, 2, 'Penetapan prosedur dan metode inspeksi', '', 'SK Prosedur dan MEtode', 'Printer, komputer, ATK', 100000000, 'Faisal Syaiful Anwar, S.Kom', '25-29', NULL),
(3, 2, 'Penyusunan draft panduan inspeksi', '<p>Panduan inspeksi disusun sebagai dasar petugas/juru melakukan inspeksi lapangan. Panduan inspeksi merupakan petunjuk teknis melakukan inspeksi sungai, hal-hal apa saja yang perlu diamati dilapangan saat melakukan inspeksi agar hasil yang didapatkan dapat menyimpulkan jenis kerusakan dan tindakan apa yang perlu dilakukan untuk memperbaiki jenis keruksan tersebut</p>', 'Draft Hasil Akhir', 'Printer, Komputer, ATK, Scanner, Internet', 100000000, 'Faisal Syaiful Anwar, S.Kom', '29-33', NULL),
(4, 2, 'Forum group discussion ', '', 'Laporan hasil diskusi FGD', 'Internet, komputer, printer', 46944000, '', '30-36', NULL),
(5, 2, 'Finalisasi panduan inspeksi', '<p>Tindak lanjut dari hasil diskusi dilakukan finalisasi dan panduan inspeksi yang disusun sebagai dasar pembuatan aplikasi perangkat &nbsp;lunak inspeksi sungai dan prasarana sungai</p>', 'Panduan PDF', 'Printer, Komputer, ATK, Scanner, Internet', 47070000, 'Faisal Syaiful Anwar, S.Kom', '35-36', NULL),
(6, 6, 'Perencanaan perangkat lunak inspeksi', '<p>Perencanaan terhadap menu atau fitur yang perlu ditampilkan dalam aplikasi ,perumusan sistem alur informasi inspeksi sampai dengan pelaporan hasil inspeksi dan penetapan tingkat jenis kerusakan</p>', 'Parameter inspeksi', 'Printer, Komputer, ATK, Scanner, Internet', 15000000, '', '37-40', NULL),
(7, 6, 'Pembuatan perangkat lunak inspeksi', '<p>Pembuatan Aplikasi sesuai dengan parameter yang ditetapkan dalam panduan inspeksi &nbsp;yang sudah dibuat. Pelaksanaan pembuatan dilakukan oleh konsultan perorangan</p>', 'Software Perangkat Lunak Inspeksi', 'Laptop, Printer, Internet', 42000000, 'Faisal Syaiful Anwar, S.Kom', '25-44', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `rmp_stages_executor`
--

CREATE TABLE IF NOT EXISTS `rmp_stages_executor` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `rmp_stages_executor`
--
...
--
-- Dumping data for table `structure_organization`
--
...
(27, NULL, 'alfisss', '7815696ecbf1c96e6894b779456d330e', NULL, NULL, 'Ketua', NULL, 'alfi@gmail.com', '2018-07-10 04:08:39'),
(28, NULL, 'alfisss', '7815696ecbf1c96e6894b779456d330e', NULL, NULL, 'Ketua', NULL, 'alfi@gmail.com', '2018-07-10 04:08:52'),
(29, 'Niko Ahmad Gumilar', 'nikont', '', '12', 32, 'Ketua', '085793434357', 'nikoahmadg@gmail.com', '2018-07-10 04:14:19'),
...
--
-- Indexes for table `rmp_activity_executor`
--
...
--
-- Indexes for table `rmp_rab_activity`
--
...
--
-- Indexes for table `rmp_sdk_list`
--
ALTER TABLE `rmp_sdk_list`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rmp_sdk_plan_act`
--
ALTER TABLE `rmp_sdk_plan_act`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rmp_sdk_plan_stage`
--
ALTER TABLE `rmp_sdk_plan_stage`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rmp_sdk_title`
--
...
--
-- Indexes for table `rmp_stages_executor`
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `rmp_activity_executor`
--
ALTER TABLE `rmp_activity_executor`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
...
--
-- AUTO_INCREMENT for table `rmp_rab_activity`
--
ALTER TABLE `rmp_rab_activity`
...
--
-- AUTO_INCREMENT for table `rmp_sdk_list`
--
ALTER TABLE `rmp_sdk_list`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rmp_sdk_plan_act`
--
ALTER TABLE `rmp_sdk_plan_act`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `rmp_sdk_plan_stage`
--
ALTER TABLE `rmp_sdk_plan_stage`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rmp_sdk_title`
--
ALTER TABLE `rmp_sdk_title`
...
--
-- AUTO_INCREMENT for table `rmp_stages_executor`
--
ALTER TABLE `rmp_stages_executor`

...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Feb 2019 pada 06.13
...
INSERT INTO `kegiatan` (`id`, `user_id`, `judul`, `tahun_anggaran`, `jenis`, `dipa`, `dipa_date`, `pagu`, `output`, `volume`, `unitof`, `rabtitle`, `att4`, `att5`, `t_keuangan`, `t_fisik`, `r_keuangan`, `r_fisik`, `rmp_stats`) VALUES
(4, 1, 'Pengembangan Website SIPROMON', 2018, 'Litbang', NULL, NULL, 527686333, 'Aplikasi Simonev', '1 (Satu)', 'Aplikasi', 'Pengembangan Aplikasi', 'JadwalPersonil_1528037049.pdf', 'JadwalSarpras__1528037050.pdf', 0, 0, 0, 0, 2),
(16, 1, 'tes v4 nov 18 non lit', 2018, 'Non-Litbang', 'DIPA/BL/2019', '2018-11-01', 565000000, 'Aplikai Simonev', '1 (satu)', 'Unit Aplikasi', 'Pengembangan Aplikasi', NULL, NULL, 100, 100, 8.84956, 8.84956, 1),
(17, 1, 'PENGEMBANGAN TEKNOLOGI PENGAMAN PANTAI DENGAN STRUKTUR BUIS BETON DAN\r\nTIANG PANCANG', 2019, 'Litbang', 'DIPA/BL/20189', '2018-11-23', 900000000, 'Aplikasi', 'Satu', 'Aplikasi', 'Gtws', NULL, NULL, 0, 0, 0, 0, 1),
(18, 30, 'Coba Janur', 2019, 'Litbang', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, NULL),
(21, 1, 'Pemaparan Layanan Jasa Teknik B4T oleh Kepala Bidang Standarisasi', 2019, 'Litbang', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, NULL);
...
INSERT INTO `mnv_fisik` (`id_mnv_fisik`, `id_kegiatan`, `biaya`, `biayaP`, `fisik`, `fisik_real`, `month`, `id_refer`, `output`, `deskripsi`, `kendala`, `tingkat_kendala`, `type`) VALUES
(1, 16, 50000000, 8.84956, 100, 8.84956, 1, 13, 'Dokumen', '', 'Lupa isi', 4, 'act');
...
INSERT INTO `mnv_keuangan` (`id_mnv_keuangan`, `month`, `jml_uang`, `jml_uangP`, `waktu_update`, `id_rmp_sdk`, `id_kegiatan`, `kendala`) VALUES
(1, 1, 122000000, 21.5929, '2018-11-17 04:58:26', 0, 16, '-');
...
(16, 19, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(17, 20, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(18, 21, '<p>asd</p>\r\n', '<p>asdadadasdsa</p>\r\n', NULL, '<p>zxczczxc</p>\r\n', '<p>qweqeqweqwe</p>\r\n', NULL, NULL, '<p>zxcxzczxc</p>\r\n', NULL, NULL, NULL, '<p>qweqewqe</p>\r\n', '<p>qwewqeq</p>\r\n', '<p>asdadasd</p>\r\n', '<p>qweqweasdad</p>\r\n', '<p>zxczc</p>\r\n', NULL, NULL, NULL, NULL, NULL, 0);
...
(0, 18, 'Diskusi Rancangan Kerja', '<p>asdsad</p>\r\n', 'A', NULL, '', '', NULL, 0, NULL, NULL, NULL),
...
(13, 13, 'tes1', '', 'A', 'TEST', 'asda', 'TEST', 'TEST', 60000000, 'Slamet Lestari, S.T., M.T.', '1-6', NULL),
(14, 13, 'tes2', '', 'A', NULL, '', '', NULL, 65000000, NULL, NULL, NULL),
(15, 13, 'tes21', '', 'B', NULL, '', '', NULL, 0, NULL, NULL, NULL),
(16, 13, 'tes22', '', 'B', NULL, '', '', NULL, 152000000, NULL, NULL, NULL),
(17, 13, 'tes23', '', 'B', NULL, '', '', NULL, 4500000, NULL, NULL, NULL),
(18, 13, 'tes31', '', 'C', NULL, '', '', NULL, 25000000, NULL, NULL, NULL),
...
--
-- Struktur dari tabel `rmp_analisis`
--

CREATE TABLE `rmp_analisis` (
  `anal_id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
  `anal_isu` varchar(255) NOT NULL,
  `anal_risiko` varchar(255) NOT NULL,
  `anal_tindakan` varchar(255) NOT NULL,
  `anal_rencana` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `rmp_analisis`
--

INSERT INTO `rmp_analisis` (`anal_id`, `rmp_id`, `anal_isu`, `anal_risiko`, `anal_tindakan`, `anal_rencana`) VALUES
(1, 18, 'asdsadad', 'qwe', 'asdz', 'zxc'),
(2, 18, 'asdadasd', 'qwe', 'zxc', 'asdad');
...
(0, 13, 'Faisal Syaiful Anwar', '2012', 'Implementasi TOEFL', 'Sanubari', 'Bandung'),
...
(0, 13, 'Dokuemn RMP', 'Lemari No  2 Rak 1<br/>Ketua Tim', 'Aktif : 1 Tahun<br/>Inaktif : 3 Tahun'),
...
(27, 18, 'Penanggung Jawab', 'Mengendalikan pelaksanaan kegiatan sesuai  Penetapan Kinerja (PK) dan RKA-K/L dan DIPA Satuan Kerja $satker. Tahun Anggaran $tahun', 'Bertanggungjawab kepada Kepala Puslitbang Sumber Daya Air terhadap tecapainya output kegiatan sesuai PK.', 'Mengusulkan personil pelaksana kegiatan dan menetapkan arah kebijakan pelaksanaan dan penggunaan anggaran kegiatan.'),
(28, 18, 'Koordinator ', 'Membantu Penanggung Jawab mengkoordinasikan dan mengevaluasi kegiatan.', 'Bertanggungjawab kepada Penanggung Jawab terhadap kelancaran kegiatan.', 'Melakukan supervisi teknis dan administrasi pelaksanaan serta penggunaan anggaran kegiatan.'),
(29, 18, 'Ketua Tim Kegiatan ', 'Merancang, memimpin dan memantau serta melaporkan pelaksanaan kegiatan', 'Bertanggung jawab kepada Penanggung jawab melalui koordinator atas pelaksanaan kegiatan.', 'Mengusulkan dan menggunakan sumber daya dalam pelaksanaan kegiatan.');
...
(0, 13, 0, '456456', 'Belanja Jasa', '500000000'),
...
INSERT INTO `rmp_sdk_plan_act` (`id`, `act_id`, `month`, `week`, `sdk_id`, `id_kegiatan`, `biaya`, `biayaP`, `fisik`) VALUES
(8, 13, 1, 0, 0, 16, 50000000, 8.84956, 8.84956),
(9, 13, 3, 0, 0, 16, 10000000, 1.76991, 1.76991),
(10, 14, 1, 0, 0, 16, 50000000, 8.84956, 8.84956),
(11, 14, 3, 0, 0, 16, 15000000, 2.65487, 2.65487),
(12, 16, 4, 0, 0, 16, 152000000, 26.9027, 26.9027),
(13, 17, 5, 0, 0, 16, 4500000, 0.79646, 0.79646),
(14, 18, 5, 0, 0, 16, 25000000, 4.42478, 4.42478);
...
INSERT INTO `rmp_sdk_plan_stage` (`id`, `stage_id`, `sdk_id`, `id_kegiatan`, `month`, `week`, `biaya`, `biayaP`, `fisik`) VALUES
(6, 11, 0, 16, 1, 0, 10000000, 1.76991, 1.76991),
(7, 11, 0, 16, 2, 0, 10000000, 1.76991, 1.76991),
(8, 8, 0, 16, 1, 0, 12000000, 2.12389, 2.12389),
(9, 8, 0, 16, 3, 0, 100000000, 17.6991, 17.6991),
(10, 9, 0, 16, 4, 0, 100000000, 17.6991, 17.6991),
(12, 10, 0, 16, 5, 0, 26500000, 4.69027, 4.69026);
...
(0, 0, 'Jasa Konsultan Website', '1org x 5bulan', 1, 50000000, 50000000),
...
(8, 15, 'tes211', '', NULL, '', '', NULL, 112000000, NULL, NULL, NULL),
(9, 15, 'tes212', '', NULL, '', '', NULL, 100000000, NULL, NULL, NULL),
(10, 19, 'tes322', '', NULL, '', '', NULL, 26500000, NULL, NULL, NULL),
(11, 20, 'tes131', '', NULL, '', '', NULL, 20000000, NULL, NULL, NULL),
...
--
-- Struktur dari tabel `rmp_swot`
--

CREATE TABLE `rmp_swot` (
  `swot_id` int(11) NOT NULL,
  `rmp_id` int(11) NOT NULL,
  `swot_factor` varchar(255) NOT NULL,
...
--
-- Dumping data untuk tabel `rmp_swot`
--

INSERT INTO `rmp_swot` (`swot_id`, `rmp_id`, `swot_factor`, `swot_u`, `swot_s`, `swot_g`, `swot_parent`) VALUES
(2, 18, 'Cek Faktor1', 1, 2, 3, 1),
(4, 18, 'Cek Faktor3', 3, 3, 3, 1),
(5, 18, 'Ancaman1', 2, 3, 4, 4),
(6, 18, 'aasdsad', 3, 4, 5, 2);
...
--
-- Indeks untuk tabel `rmp_analisis`
--
ALTER TABLE `rmp_analisis`
  ADD PRIMARY KEY (`anal_id`);
...
--
-- Indeks untuk tabel `rmp_swot`
--
ALTER TABLE `rmp_swot`
  ADD PRIMARY KEY (`swot_id`);
...
--
ALTER TABLE `mnv_fisik`
  MODIFY `id_mnv_fisik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `mnv_keuangan`
--
ALTER TABLE `mnv_keuangan`
  MODIFY `id_mnv_keuangan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT untuk tabel `rmp_analisis`
--
ALTER TABLE `rmp_analisis`
  MODIFY `anal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT untuk tabel `rmp_swot`
--
ALTER TABLE `rmp_swot`
  MODIFY `swot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;

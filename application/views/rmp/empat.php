										...
										<div>
									      ...
									      <select id="navigate" class="form-control" style="margin-left:-15px; background-color:#ffd700;">
											...
											<div class="pull-right" style="margin-bottom: 15px;">
												...
												<a href="<?=base_url(); ?>RMP/lima/<?=$this->uri->segment(3)?>" type="button" class="btn btn-labeled btn-success">
														<span class="btn-label"><i class="fa fa-fw fa-arrow-right"></i></span> Bab V
												</a>
											</div>
										</div>
									</div>
								</div>
								<?php echo form_open('RMP/empat/'.$this->uri->segment(3)); ?>
								<div class="row">
									<div class="col-md-3">
										<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#persyaratanteknis" role="tab" aria-controls="latar" aria-selected="true">Persyaratan Teknis</a>
											<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#persyaratanadministrasi" role="tab" aria-controls="masalah" aria-selected="false">Persyaratan Administrasi</a>
									...
									<div class="col-md-9">
										<div class="tab-content" id="v-pills-tabContent">
											<div class="tab-pane fade show active" id="persyaratanteknis" role="tabpanel">
												<div class="card-title">
													<h3 class="text-center">Persyaratan Teknis</h3>
													<hr>
													<textarea class="ckeditor" name="persyaratanteknis" ><?=$row['persyaratanteknis'];?></textarea>
												</div>
											</div>
											<div class="tab-pane fade" id="persyaratanadministrasi" role="tabpanel">
												<div class="card-title">
													<h3 class="text-center">Persyaratan Administrasi</h3>
													<hr>
													<textarea class="ckeditor" name="persyaratanadministrasi" ><?=$row['persyaratanadministrasi'];?></textarea>
												</div>
											</div>

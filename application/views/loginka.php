            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <?php echo form_open('Auth/login',['class' => 'needs-validation']); ?>
                        <center><p>Masuk Kepala Pusair</p></center>
                        ...
                        <a href="<?=base_url(); ?>Auth" type="button" class="btn btn-labeled btn-success">
                                <span class="btn-label"><i class="fa fa-fw fa-arrow-left"></i></span> Ketua Tim
                        </a>                                                
                        <br>
                        <br>
                        <a href="<?=base_url(); ?>Auth/es3" type="button" class="btn btn-labeled btn-info">
                                <span class="btn-label"><i class="fa fa-fw fa-arrow-right"></i></span> Eselon 3
                        </a>                                                
                        <br>
                        <br>

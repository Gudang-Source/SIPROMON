		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active">
						<a href="<?=base_url();?>Eselon/berandaes3"> <i class="menu-icon fa fa-home"></i>Halaman Utama</a>
					</li>
					<li>
						<a href="<?=base_url();?>Kegiatan"> <i class="menu-icon fa fa-th-list"></i>Semua Kegiatan</a>
					</li>
				</ul>
			</div><!-- /.navbar-collapse -->
		</nav>
